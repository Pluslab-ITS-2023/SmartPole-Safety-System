...
# # def plot_trajectories(input_file_name: str, output_file_name: str) -> None:
# #     """
# #     CSVファイルからvehicleidごとの軌跡を描画する。

# #     vehicleidごとに色を変え、timeの時系列順に
# #     latitudeとlongitudeを線分で結ぶ。
...
# #         print(f"⚠️ 指定されたファイル {input_file} はCSVファイルではありません.")
# #         return
...
# #             dpi=150
# #         )
# #         print(f"✅ 軌跡画像 {output_file} を保存しました.")
# #     except Exception as e:
# #         print(f"⚠️ 画像の保存に失敗しました ({e}).")
# #     finally:
# #         plt.close()
...
#         if df.empty:
#             print("⚠️ 指定されたvehicleidに該当するデータがありません.")
#             return
...
#     parser = argparse.ArgumentParser(
#         description="CSVファイルからvehicleidごとの軌跡を描画します."
#     )
